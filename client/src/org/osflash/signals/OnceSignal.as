...
public class OnceSignal implements IOnceSignal
{
     ...
     * @param	valueClasses Any number of class references that enable MsgType checks in dispatch().
    ...
    public function dispatch(...valueObjects):void
    {
        ...
        // If valueClasses is empty, value LOEBUILD_5891da2d64975cae48d175d1e001f5da are not MsgType-checked.
        const numValueClasses:int = _valueClasses.length;
        const numValueObjects:int = valueObjects.length;

        // Cannot dispatch fewer LOEBUILD_5891da2d64975cae48d175d1e001f5da than declared classes.
        ...
        // Cannot dispatch differently typed LOEBUILD_5891da2d64975cae48d175d1e001f5da than declared classes.
