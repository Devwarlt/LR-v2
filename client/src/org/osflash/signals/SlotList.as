...
{
/**
 * The SlotList class represents an immutable list of Slot LOEBUILD_5891da2d64975cae48d175d1e001f5da.
 *
 * @author Joa Ebert
...
public final class SlotList
{
    ...
    *
    * @throws ArgumentError <code>ArgumentError</code>: LOEBUILD_3225a10b07f1580f10dee4abc3779e6c head and tail are null. Use the NIL element instead.
   ...
   public function SlotList(head:ISlot, tail:SlotList = null)
   {
      ...
      {
         if (NIL)
            throw new ArgumentError('LOEBUILD_3225a10b07f1580f10dee4abc3779e6c head and tail are null. Use the NIL element instead.');
