...
public class QuestRewardsView extends EmptyFrame {
      ...
      public function init(param1:int, param2:int, param3:String, param4:String) : void {
         var _local7:TextField = null;
         var _local10:TextFormat = null;
         var _local5:String = "Tier " + param1.toString();
         ...
         addChild(_local7);
         var _local8:String = LineBuilder.getLocalizedStringFromKey(LOEBUILD_efda783509bc93eea698457c87bbee3f.typeToDisplayId_[param2]);
         this.constructDescription(param3,_local8);
         this.addCloseButton();
         ...
         var _local9:BitmapData = LOEBUILD_efda783509bc93eea698457c87bbee3f.getRedrawnTextureFromType(param2,80,true,false);
      ...
      public function noNewQuests() : void {
         ...
         var _local5:TextFormat = _local4.apply(_local1,32,16777215,true,true);
         _local1.selectable = false;
         _local1.x = 0;
         _local1.y = 150;
         _local1.embedFonts = true;
         _local1.filters = [new GlowFilter(49941)];
         addChild(new LOEBUILD_e381592941e087d5644194bd1995159f(1));
         addChild(_local1);
      ...
      public function constructDescription(param1:String, param2:String = "") : void {
         ...
         var _local6:TextFormat = null;
         var _local3:int = param1.indexOf("{goal}");
         if(_local3 != -1) {
            _local4 = param1.split("{goal}").join(param2);
         ...
         if(_local3 != -1) {
            _local6 = desc.getTextFormat(_local3,_local3 + param2.length);
            _local6.color = 196098;
            _local6.bold = true;
            desc.setTextFormat(_local6,_local3,_local3 + param2.length);
         }
      }
      ...
      public function onQuestComplete() : void {
         ...
         this.rightSlot.highLightAll(2368548);
