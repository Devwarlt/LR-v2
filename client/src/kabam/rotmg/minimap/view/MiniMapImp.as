...
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.Character;
...
public class MiniMapImp extends MiniMap {
      ...
      public function MiniMapImp(param1:int, param2:int) {
         ...
         this._width = param1;
         this._height = param2;
         this._rotateEnableFlag = LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.data_.allowMiniMapRotation;
         this.makeVisualLayers();
         this.addMouseListeners();
      }

      public static function gameObjectToColor(param1:GameObject) : uint {
         var _local2:* = param1.objectType_;
         if(!objectTypeColorDict_.hasOwnProperty(_local2)) {
            objectTypeColorDict_[_local2] = param1.getColor();
         }
         return objectTypeColorDict_[_local2];
      }

      override public function setMap(param1:LOEBUILD_fa44c2f4ed610d0a29b25a8fff9d67e7) : void {
         this.map = param1;
         this.makeViewModel();
      }
      ...
      private function onMapRightClick(param1:MouseEvent) : void {
         this._rotateEnableFlag = !this._rotateEnableFlag && Boolean(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.data_.allowMiniMapRotation);
      }
      ...
      override public function setGroundTile(param1:int, param2:int, param3:uint) : void {
         var _local4:uint = LOEBUILD_0bd5afc531164aa9bf1c5f132d4a86a5.getColor(param3);
         this.miniMapData_.setPixel(param1,param2,_local4);
      }

      override public function setGameObjectTile(param1:int, param2:int, param3:GameObject) : void {
         var _local4:uint = gameObjectToColor(param3);
         this.miniMapData_.setPixel(param1,param2,_local4);
      }
      ...
      override public function draw() : void {
         var _local7:Graphics = null;
         var _local10:GameObject = null;
         var _local15:uint = 0;
         var _local16:Player = null;
         var _local17:Number = NaN;
         var _local18:Number = NaN;
         var _local19:Number = NaN;
         var _local20:Number = NaN;
         var _local21:Number = NaN;
         this._rotateEnableFlag = Boolean(this._rotateEnableFlag) && Boolean(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.data_.allowMiniMapRotation);
         ...
         if(_local1 >= 1 && Boolean(this._rotateEnableFlag)) {
            this.mapMatrix_.rotate(-LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.data_.cameraAngle);
         }
         ...
         for each(_local10 in map.goDict_) {
            if(!(Boolean(_local10.props_.noMiniMap_) || _local10 == this.focus)) {
               ...
               } else if(_local10 is Character) {
                  if(_local10.props_.nm_) {
                     _local15 = 16711680;
                  } else {
                     _local15 = gameObjectToColor(_local10);
                  }
               } else if(_local10 is Portal || _local10 is GuildHallPortal) {
                  _local15 = 255;
               } else {
                  continue;
               }
               ...
               if(_local16 != null && Boolean(this.isMouseOver) && (this.menu == null || this.menu.parent == null)) {
         ...
         if(!(_local1 >= 1 && Boolean(this._rotateEnableFlag))) {
            this.arrowMatrix_.rotate(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.data_.cameraAngle);
         }
      ...
      private function areSamePlayers(param1:Vector.<Player>, param2:Vector.<Player>) : Boolean {
         var _local3:int = param1.length;
         if(_local3 != param2.length) {
            return false;
         }
         var _local4:int = 0;
         while(_local4 < _local3) {
            if(param1[_local4] != param2[_local4]) {
               return false;
            }
            _local4++;
         }
