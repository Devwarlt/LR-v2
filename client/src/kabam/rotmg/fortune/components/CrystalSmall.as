...
public class CrystalSmall extends Sprite {
      ...
      public function CrystalSmall() {
         ...
         while(_local2 < 3) {
            ...
            _local1 = TextureRedrawer.redraw(_local1,this.size_,true,16777215,true);
         ...
         _local1 = AssetLibrary.getImageFromSet("lofiCharBig",256);
      ...
      public function doItemShow(param1:int) : void {
         ...
         _local2.indent = 0;
         _local2.leading = 0;
         this.itemNameField.text = LineBuilder.getLocalizedStringFromKey(LOEBUILD_efda783509bc93eea698457c87bbee3f.typeToDisplayId_[param1]);
      ...
      public function doItemCenter(param1:Number, param2:Number) : void {
         this.returnX = this.x;
         this.returnY = this.y;
         var _local3:Number = this.calculateXPos(param1);
         var _local4:Number = this.calculateYPos(param2);
      ...
      public function update(param1:int, param2:int) : void {
         ...
         if(this.glowState == GLOW_STATE_FADE) {
            ...
            if(this.glowFilter.alpha >= 0.95 && Boolean(this.pulsePolarity)) {
