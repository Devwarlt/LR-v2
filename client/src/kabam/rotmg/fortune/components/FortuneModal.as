...
public class FortuneModal extends EmptyFrame {
      ...
      private var particleMap:LOEBUILD_e381592941e087d5644194bd1995159f;
      ...
      public function FortuneModal(param1:GameSprite = null) {
         ...
         modalIsOpen = true;
         this.makePlatforms();
         this.pscale = LOEBUILD_e381592941e087d5644194bd1995159f.PSCALE;
         this.particleMap = new LOEBUILD_e381592941e087d5644194bd1995159f();
      ...
      public static function doEaseOutInAnimation(param1:DisplayObject, param2:Object = null, param3:Object = null, param4:Function = null) : void {
         var _local5:GTween = new GTween(param1,0.5 * 1,param2,{"ease":Sine.easeOut});
         _local5.nextTween = new GTween(param1,0.5 * 1,param3,{"ease":Sine.easeIn});
         _local5.nextTween.paused = true;
         _local5.nextTween.end();
         _local5.nextTween.onComplete = param4;
      }
      ...
      private function onItemSwitch(param1:TimerEvent = null) : void {
         var _local5:ItemWithTooltip = null;
      ...
      private function doEaseInAnimation(param1:DisplayObject, param2:Object = null, param3:Function = null) : void {
         var _local4:GTween = new GTween(param1,0.5,param2,{
            "ease":Sine.easeOut,
            "onComplete":param3
         });
      }
      ...
      private function onFirstBuySub(param1:int) : void {
         ...
         if(_local2 != null) {
            if(param1 == Currency.GOLD && this.state == STATE_ROUND_2 && _local2.credits_ - this.goldPriceSecond_ < 0) {
               _local4 = StaticInjectorContext.getInjector().getInstance(OpenDialogSignal);
               _local4.dispatch(new NotEnoughGoldDialog());
               return;
            }
            if(param1 == Currency.GOLD && _local2.credits_ - this.goldPrice_ < 0) {
               _local4 = StaticInjectorContext.getInjector().getInstance(OpenDialogSignal);
               _local4.dispatch(new NotEnoughGoldDialog());
               return;
            }
            if(param1 == Currency.FORTUNE && _local2.tokens_ - this.tokenPrice_ < 0) {
               return;
            }
         }
         ...
         if(param1) {
            ...
            if(_local4 != null) {
               if(_local3.hasOwnProperty("Gold")) {
                  ...
                  this.creditDisplay_.draw(_local4.credits_,0,_local4.tokens_);
               } else if(_local3.hasOwnProperty("FortuneToken")) {
            ...
            for each(_local17 in this.items) {
               ...
               if(_local7) {
                  ...
                  _local6 = --_local6 < 0?2:int(_local6);
               }
            }
      ...
      private function onFirstBuyAnimateComplete() : void {
         ...
         while(_local1 < 3) {
            if(!(this.state == STATE_ROUND_2 && this.crystals[_local1] == this.crystalClicked)) {
               ...
               new TimerCallback(this.NOVA_DELAY_TIME,this.doNova,int(this.crystals[_local1].returnCenterX()),int(this.crystals[_local1].returnCenterY()),5,65535);
      ...
      private function setCountdownWarningString() : void {
         if(this.countdownTimer != null && Boolean(this.countdownTimer.isRunning())) {
            this.setString(9);
         }
      }

      private function handleError() : void {
         var _local1:OpenDialogSignal = null;
      ...
      private function onErrorOk(param1:Event) : void {
         var _local2:CloseDialogsSignal = null;
      ...
      private function smallBallClick(param1:Object) : void {
         ...
         var _local3:int = 0;
         while(_local3 < 3) {
            if(this.crystals[_local3] == param1) {
      ...
      private function onSmallBallClickCompleteRound2(param1:int) : void {
         ...
         while(_local2 < this.items.length) {
            if(int(this.items[_local2]) == param1) {
      ...
      private function ballClickEnable(param1:CrystalSmall = null) : void {
         var _local2:int = 0;
         while(_local2 < 3) {
            if(this.crystals[_local2] == param1) {
      ...
      private function resetBalls() : void {
         ...
         while(_local2 < 3) {
            ...
            } else if(this.crystals[_local2].visible == false) {
      ...
      private function doNova(param1:Number, param2:Number, param3:int = 20, param4:int = 12447231) : void {
         ...
         var _local6:NovaEffect = null;
         if(this.particleMap != null) {
            _local5 = new GameObject(null);
            _local5.x_ = LOEBUILD_e381592941e087d5644194bd1995159f.getLocalPos(param1);
            _local5.y_ = LOEBUILD_e381592941e087d5644194bd1995159f.getLocalPos(param2);
            _local6 = new NovaEffect(_local5,param3,param4);
      ...
      private function doLightning(param1:Number, param2:Number, param3:Number, param4:Number, param5:int = 200, param6:int = 12447231) : void {
         ...
         _local7.x_ = LOEBUILD_e381592941e087d5644194bd1995159f.getLocalPos(param1);
         _local7.y_ = LOEBUILD_e381592941e087d5644194bd1995159f.getLocalPos(param2);
         var _local8:WorldPosData = new WorldPosData();
         _local8.x_ = LOEBUILD_e381592941e087d5644194bd1995159f.getLocalPos(param3);
         _local8.y_ = LOEBUILD_e381592941e087d5644194bd1995159f.getLocalPos(param4);
         var _local9:LightningEffect = new LightningEffect(_local7,_local8,param6,param5);
