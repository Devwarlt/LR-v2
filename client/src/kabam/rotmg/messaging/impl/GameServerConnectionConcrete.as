...
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.FlashDescription;
...
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.LOEBUILD_83c7af17e580756c4c914e5fc723c63c;
...
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.ObjectProperties;
...
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.ProjectileProperties;
...
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.AOEEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.BurstEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.CollapseEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.ConeBlastEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.FlowEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.HealEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.LightningEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.LineEffect;
...
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.PoisonEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.RingEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.RisingFuryEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.ShockeeEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.ShockerEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.StreamEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.TeleportEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.ThrowEffect;
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.LOEBUILD_357498e03a88a17f471aba561d9fe677.LOEBUILD_1c9fba6513bfdb9d6c091f95f1c141d4;
...
public class GameServerConnectionConcrete extends GameServerConnection {
    ...
    public function GameServerConnectionConcrete(_arg1:LOEBUILD_6615c4f9bea4fdaf620bf1ad513a54c1, _arg2:Server, _arg3:int, _arg4:Boolean, _arg5:int, _arg6:int, _arg7:ByteArray, _arg8:String, _arg9:Boolean) {
    ...
    private function getPetUpdater():void {
        this.injector.map(LOEBUILD_6615c4f9bea4fdaf620bf1ad513a54c1).toValue(gs_);
        this.petUpdater = this.injector.getInstance(PetUpdater);
        this.injector.unmap(LOEBUILD_6615c4f9bea4fdaf620bf1ad513a54c1);
    }
    ...
    override public function connect():void {
        ...
        _local1.name = LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.CLIENT_CHAT_NAME;
    ...
    private function onActivePetUpdate(_arg1:ActivePet):void {
        ...
        this.addTextLine.dispatch(ChatMessage.make(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.SERVER_CHAT_NAME, _local3, -1, -1, "", false, {petName: _local2}));
    }
    ...
    private function encryptConnection():void {
        var _local1:ICipher;
        var _local2:ICipher;
        if (LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.ENABLE_ENCRYPTION) {
    ...
    override public function buy(_arg1:int, _arg2:int):void {
        ...
        var _local3:LOEBUILD_4f1c60f303d750123192c52bfb412b04 = gs_.map.goDict_[_arg1];
        if (_local3 == null) {
            return;
        }
        var _local4:Boolean;
    ...
    private static function rsaEncrypt(_arg1:String):String {
        var _local2:RSAKey = PEM.readRSAPublicKey(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.RSA_PUBLIC_KEY);
    ...
    private function onConnected():void {
        ...
        this.addTextLine.dispatch(ChatMessage.make(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.CLIENT_CHAT_NAME, TextKey.CHAT_CONNECTED));
        this.encryptConnection();
        var _local2:Hello = (this.messages.require(HELLO) as Hello);
        _local2.buildVersion_ = ((LOEBUILD_9e66824be5912020ae4304d695ae300a.LOEBUILD_f80f1ecc62a94ff993708804db5bbdbd + ".") + LOEBUILD_9e66824be5912020ae4304d695ae300a.LOEBUILD_bcd70d36f5cceaccaf0481d68e756080);
    ...
    private function onDamage(_arg1:Damage):void {
        var _local5:int;
        var _local2:LOEBUILD_fa44c2f4ed610d0a29b25a8fff9d67e7 = gs_.map;
    ...
    private function onAllyShoot(_arg1:AllyShoot):void {
        ...
        if (LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.data_.allyProjs)
    ...
    private function onTradeRequested(_arg1:TradeRequested):void {
        if (!LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.data_.chatTrade) {
            return;
        }
        if (((LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.data_.tradeWithFriends) && (!(this.friendModel.isMyFriend(_arg1.name_))))) {
            return;
        }
        if (LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.data_.showTradePopup) {
    ...
    private function onTradeDone(_arg1:TradeDone):void {
        ...
        this.addTextLine.dispatch(ChatMessage.make(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.SERVER_CHAT_NAME, _local2, -1, -1, "", false, _local3));
    }
    ...
    private function addObject(_arg1:ObjectData):void {
        var _local2:LOEBUILD_fa44c2f4ed610d0a29b25a8fff9d67e7 = gs_.map;
        var _local3:GameObject = LOEBUILD_efda783509bc93eea698457c87bbee3f.getObjectFromType(_arg1.objectType_);
        if (_local3 == null) {
            return;
        }
    ...
    private function handleNewPlayer(_arg1:Player, _arg2:LOEBUILD_fa44c2f4ed610d0a29b25a8fff9d67e7):void {
    ...
    private function onNotification(_arg1:Notification):void {
        ...
        var _local4:LOEBUILD_862a0e20385d01174a45beed4b836305;
        ...
        if (_local2 != null) {
            ...
            if (_local3.key == "server.plus_symbol") {
                _local4 = new LOEBUILD_862a0e20385d01174a45beed4b836305(_local2, _arg1.color_, 1000);
    ...
    private function onShowEffect(_arg1:ShowEffect):void {
        ...
        switch (_arg1.effectType_) {
            ...
            case ShowEffect.THROW_PROJECTILE_EFFECT_TYPE:
                ...
                _local4 = new LOEBUILD_1c9fba6513bfdb9d6c091f95f1c141d4(_arg1.color_, _arg1.pos2_.toPoint(), _arg1.pos1_.toPoint());
                _local2.addObj(_local4, _local5.x, _local5.y);
                return;
        ...
        for each (_local7 in _arg2) {
            ...
            switch (_local7.statType_) {
                ...
                case StatData.MERCHANDISE_PRICE_STAT:
                    (_arg1 as LOEBUILD_4f1c60f303d750123192c52bfb412b04).setPrice(_local8);
                    break;
                ...
                case StatData.MERCHANDISE_CURRENCY_STAT:
                    (_arg1 as LOEBUILD_4f1c60f303d750123192c52bfb412b04).setCurrency(_local8);
                    break;
                ...
                case StatData.MERCHANDISE_RANK_REQ_STAT:
                    (_arg1 as LOEBUILD_4f1c60f303d750123192c52bfb412b04).setRankReq(_local8);
                    break;
                ...
                case StatData.RANK_REQUIRED_STAT:
                    (_arg1 as LOEBUILD_83c7af17e580756c4c914e5fc723c63c).setRankRequired(_local8);
                    break;
    ...
    private function processObjectStatus(_arg1:ObjectStatusData, _arg2:int, _arg3:int):void {
        ...
        var _local18:Array;
        var _local4:LOEBUILD_fa44c2f4ed610d0a29b25a8fff9d67e7 = gs_.map;
        ...
        if (_local7) {
            ...
            if (_local7.skinId != _local10) {
                if (LOEBUILD_efda783509bc93eea698457c87bbee3f.skinSetXMLDataLibrary_[_local7.skinId] != null) {
                    _local12 = (LOEBUILD_efda783509bc93eea698457c87bbee3f.skinSetXMLDataLibrary_[_local7.skinId] as XML);
                    ...
                    if (_local14.length > 0) {
                        ...
                        _local16 = LOEBUILD_efda783509bc93eea698457c87bbee3f.propsLibrary_[_local15];
    ...
    private function onReconnect(_arg1:Reconnect):void {
        ...
        var _local8:LOEBUILD_c7f41ff76637f7e98124a836c410d43a = new LOEBUILD_c7f41ff76637f7e98124a836c410d43a(_local2, _local3, _local4, _local5, _local6, _local7, isFromArena_);
    ...
    private function parseXML(_arg1:String):void {
        ...
        LOEBUILD_0bd5afc531164aa9bf1c5f132d4a86a5.parseFromXML(_local2);
        LOEBUILD_efda783509bc93eea698457c87bbee3f.parseFromXML(_local2);
        LOEBUILD_efda783509bc93eea698457c87bbee3f.parseFromXML(_local2);
    }
    ...
    private function handleBuyResultType(_arg1:BuyResult):void {
        ...
        switch (_arg1.result_) {
            case BuyResult.UNKNOWN_ERROR_BRID:
                _local2 = ChatMessage.make(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.SERVER_CHAT_NAME, _arg1.resultString_);
    ...
    private function handleDefaultResult(_arg1:BuyResult):void {
        ...
        var _local4:ChatMessage = ChatMessage.make(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.ERROR_CHAT_NAME, _local2.key);
    ...
    private function onNameResult(_arg1:NameResult):void {
        gs_.dispatchEvent(new LOEBUILD_074c8fb83348087c0cf9b59ae079772a(_arg1));
    }

    private function onGuildResult(_arg1:GuildResult):void {
        var _local2:LineBuilder;
        if (_arg1.lineBuilderJSON == "") {
            gs_.dispatchEvent(new LOEBUILD_50840d80ddb06f7e096ad2c5cf1fbb1e(_arg1.success_, "", {}));
        } else {
            _local2 = LineBuilder.fromJSON(_arg1.lineBuilderJSON);
            this.addTextLine.dispatch(ChatMessage.make(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.ERROR_CHAT_NAME, _local2.key, -1, -1, "", false, _local2.tokens));
            gs_.dispatchEvent(new LOEBUILD_50840d80ddb06f7e096ad2c5cf1fbb1e(_arg1.success_, _local2.key, _local2.tokens));
        }
    }
        ...
        if (this.playerId_ != -1) {
            ...
            if (this.retryConnection_) {
                if (this.delayBeforeReconnect < 10) {
                    ...
                    this.addTextLine.dispatch(ChatMessage.make(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.ERROR_CHAT_NAME, "Connection failed!  Retrying..."));
                } else {
                    gs_.closed.dispatch();
                }
            }
    ...
    private function onError(_arg1:String):void {
        this.addTextLine.dispatch(ChatMessage.make(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.ERROR_CHAT_NAME, _arg1));
    }
    ...
    private function handleInvalidTeleportTarget(_arg1:Failure):void {
        ...
        this.addTextLine.dispatch(ChatMessage.make(LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.ERROR_CHAT_NAME, _local2));
    ...
    private function handleIncorrectVersionFailure(_arg1:Failure):void {
        ...
        _local2.setTextParams(TextKey.CLIENT_UPDATE_DESCRIPTION, {
            client: LOEBUILD_9e66824be5912020ae4304d695ae300a.LOEBUILD_f80f1ecc62a94ff993708804db5bbdbd,
