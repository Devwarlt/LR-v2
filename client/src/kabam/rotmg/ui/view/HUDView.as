...
public class HUDView extends Sprite implements UnFocusAble {
      ...
      private function createEquippedGridBackground() : void {
         ...
         var _local1:GraphicsSolidFill = new GraphicsSolidFill(6776679,1);
      ...
      public function startTrade(param1:LOEBUILD_6615c4f9bea4fdaf620bf1ad513a54c1, param2:TradeStart) : void {
         if(!this.tradePanel) {
