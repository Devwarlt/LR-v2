...
public class PetPickerMediator extends Mediator {
      ...
      override public function initialize() : void {
         ...
         if(Boolean(this.petSlotsState.rightSlotPetVO) && Boolean(this.view.doDisableUsed)) {
            this.view.filterUsedPetVO(this.petSlotsState.rightSlotPetVO);
         }
         if(Boolean(this.petSlotsState.leftSlotPetVO) && Boolean(this.view.doDisableUsed)) {
