...
public class YardUpgraderMediator extends Mediator {
      ...
      override public function initialize() : void {
         ...
         var _local3:int = _local2 < PetRarityEnum.DIVINE.ordinal?int(PetRarityEnum.selectByOrdinal(_local2 + 1).ordinal):int(PetRarityEnum.DIVINE.ordinal);
      ...
      private function purchaseUpgrade(param1:uint) : void {
         ...
         var _local3:UpgradePetYardRequestVO = new UpgradePetYardRequestVO(_local2,param1);
