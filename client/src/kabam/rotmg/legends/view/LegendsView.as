...
public class LegendsView extends Sprite {
      ...
      private function makeTab(param1:Timespan, param2:int) : LegendsTab {
         var _local3:LegendsTab = new LegendsTab(param1);
         this.tabs[param1.getId()] = _local3;
         _local3.x = 20 + param2 * 90;
         _local3.y = 70;
      ...
      private function clearLegendsList() : void {
         var _local1:LegendListItem = null;
      ...
      private function makeItemFromLegend(param1:int) : LegendListItem {
         var _local2:Legend = this.legends[param1];
         _local2.place = param1 + 1;
         var _local3:LegendListItem = new LegendListItem(_local2);
         _local3.y = param1 * LegendListItem.HEIGHT;
