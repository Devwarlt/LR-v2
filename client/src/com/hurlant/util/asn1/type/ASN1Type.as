package com.hurlant.util.asn1.type {
	...
	public class ASN1Type {
		...
		// core MsgType, vs MsgType used somewhere
...
//			core = true;
		 ...
		 * If we can't read a value that matches our MsgType, we return null;
		 * 
		...
		protected function readDERTag(s:ByteArray, classValue:int=UNIVERSAL, 
			...
			//if (any || (c==constructed)) return MsgType;
