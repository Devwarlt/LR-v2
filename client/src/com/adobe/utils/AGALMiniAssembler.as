...
public class AGALMiniAssembler {
      ...
      public function assemble(param1:String, param2:String, param3:Boolean = false) : ByteArray {
         ...
         var _local23:Array = null;
         var _local24:Array = null;
         var _local25:Register = null;
         var _local26:Array = null;
         var _local27:uint = 0;
         var _local28:uint = 0;
         var _local29:Array = null;
         var _local30:Boolean = false;
         ...
         var _local36:uint = 0;
         var _local37:int = 0;
         var _local38:Array = null;
         var _local39:Register = null;
         var _local40:Array = null;
         var _local41:Array = null;
         var _local42:uint = 0;
         var _local43:uint = 0;
         var _local44:Number = NaN;
         var _local45:Sampler = null;
         var _local46:* = null;
         var _local47:uint = 0;
         var _local48:uint = 0;
         var _local49:String = null;
         ...
         var _local6:Array = param2.replace(new RegExp("[\\f\\n\\r\\v]+","g"),"\n").split("\n");
         var _local7:int = 0;
         var _local8:int = 0;
         ...
         while(_local9 < _local10 && this._error == "") {
            ...
            _local13 = _local11.search(new RegExp("<.*>","g"));
            if(_local13 != -1) {
               _local14 = _local11.slice(_local13).match(new RegExp("([\\w\\.\\-\\+]+)","gi"));
               _local11 = _local11.slice(0,_local13);
            }
            _local15 = _local11.match(new RegExp("^\\w{3}","ig"));
            ...
            if(_local16 == null) {
               ...
               if(Boolean(_local16.flags & OP_FRAG_ONLY) && !_local5) {
               ...
               _local17 = _local11.match(new RegExp("vc\\[([vof][actps]?)(\\d*)?(\\.[xyzw](\\+\\d{1,3})?)?\\](\\.[xyzw]{1,4})?|([vof][actps]?)(\\d*)?(\\.[xyzw]{1,4})?","gi"));
               ...
               while(_local21 < _local20) {
                  _local22 = false;
                  _local23 = _local17[_local21].match(new RegExp("\\[.*\\]","ig"));
                  ...
                  _local24 = _local17[_local21].match(new RegExp("^\\b[A-Za-z]{1,2}","ig"));
                  ...
                  } else if(!(_local25.flags & REG_VERT)) {
                  ...
                  _local26 = !!_local22?_local23[0].match(new RegExp("\\d+")):_local17[_local21].match(new RegExp("\\d+"));
                  _local27 = 0;
                  if(_local26) {
                  ...
                  _local28 = 0;
                  _local29 = _local17[_local21].match(new RegExp("(\\.[xyzw]{1,4})"));
                  _local30 = _local21 == 0 && !(_local16.flags & OP_NO_DEST);
                  _local31 = _local21 == 2 && Boolean(_local16.flags & OP_SPECIAL_TEX);
                  _local32 = 0;
                  _local33 = 0;
                  _local34 = 0;
                  if(Boolean(_local30) && Boolean(_local22)) {
                  ...
                  if(_local29) {
                     ...
                     _local28 = !!_local30?uint(15):uint(228);
                  }
                  if(_local22) {
                     _local38 = _local23[0].match(new RegExp("[A-Za-z]{1,2}","ig"));
                     ...
                     _local40 = _local23[0].match(new RegExp("(\\.[xyzw]{1,1})"));
                     ...
                     _local41 = _local23[0].match(new RegExp("\\+\\d{1,3}","ig"));
                     if(_local41.length > 0) {
                        _local34 = _local41[0];
                     }
                     if(_local34 < 0 || _local34 > 255) {
                        this._error = "error: index offset " + _local34 + " out of bounds. [0..255]";
                        _local18 = true;
                        break;
                     }
                     if(param3) {
                        trace("RELATIVE: MsgType=" + _local32 + "==" + _local38[0] + " sel=" + _local33 + "==" + _local40[0] + " idx=" + _local27 + " offset=" + _local34);
                     }
                  }
                  if(param3) {
