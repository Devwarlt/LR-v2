...
public class Ruler extends Sprite {
      ...
      public function Ruler(param1:Console) {
         ...
         this._area = new Rectangle(-param1.stage.stageWidth * 1.5 + _local2.x,-param1.stage.stageHeight * 1.5 + _local2.y,param1.stage.stageWidth * 3,param1.stage.stageHeight * 3);
      ...
      private function onMouseClick(param1:MouseEvent) : void {
         ...
         if(this._points.length == 0) {
            ...
            _local4 = new Point(param1.localX,param1.localY);
      ...
      private function makeTxtField(param1:Number, param2:Boolean = true) : TextField {
         var _local3:TextFormat = new TextFormat(this._config.style.menuFont,this._config.style.menuFontSize,param1,param2,true,null,null,TextFormatAlign.RIGHT);
      ...
      private function angle(param1:Point, param2:Point) : Number {
         var _local3:Number = Math.atan2(param2.y - param1.y,param2.x - param1.x) / Math.PI * 180;
         _local3 = _local3 + 90;
         if(_local3 > 180) {
            _local3 = _local3 - 360;
         }
      ...
      private function drawCircleSegment(param1:Graphics, param2:Number, param3:Point, param4:Number = 180, param5:Number = 0) : Point {
         ...
         var _local14:Number = NaN;
         var _local15:Point = null;
         var _local6:Boolean = false;
         if(param4 < 0) {
            _local6 = true;
            param4 = Math.abs(param4);
         }
         var _local7:Number = param4 * Math.PI / 180;
         var _local8:Number = param5 * Math.PI / 180;
         var _local9:Point = this.getPointOnCircle(param2,_local8);
         _local9.offset(param3.x,param3.y);
         param1.moveTo(_local9.x,_local9.y);
         var _local10:Number = 0;
         var _local11:int = 1;
         while(_local11 <= _local7 + 1) {
            _local12 = _local11 <= _local7?Number(_local11):Number(_local7);
            _local13 = _local12 - _local10;
            _local14 = 1 + 0.12 * _local13 * _local13;
            _local15 = this.getPointOnCircle(param2 * _local14,(_local12 - _local13 / 2) * (!!_local6?-1:1) + _local8);
            _local15.offset(param3.x,param3.y);
            _local9 = this.getPointOnCircle(param2,_local12 * (!!_local6?-1:1) + _local8);
            _local9.offset(param3.x,param3.y);
            param1.curveTo(_local15.x,_local15.y,_local9.x,_local9.y);
            _local10 = _local12;
            _local11++;
         }
         return _local9;
