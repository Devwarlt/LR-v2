...
public class IntPoint {
      ...
      public function distanceAsInt(param1:IntPoint) : int {
         var _local2:int = param1.x_ - this.x_;
         var _local3:int = param1.y_ - this.y_;
      ...
      public function distanceToPoint(param1:Point) : Number {
         var _local2:int = param1.x - this.x_;
         var _local3:int = param1.y - this.y_;
         return Math.sqrt(_local2 * _local2 + _local3 * _local3);
      }
      ...
      public function transform(param1:Matrix) : IntPoint {
         var _local2:Point = param1.transformPoint(this.toPoint());
