...
public class PNGDecoder {
      ...
      private static function gettEXt(param1:int, param2:int) : XML {
         ...
         _local5 = fileIn.readUTFBytes(param1 + param2 - fileIn.position);
         _local3.appendChild(<keyword>{_local4}</keyword>);
         _local3.appendChild(<text>{_local5}</text>);
         return _local3;
      }
      ...
      private static function getzTXt(param1:int, param2:int) : XML {
         ...
         if(_local7 == 0) {
            ...
            _local8.writeBytes(fileIn,fileIn.position,param1 + param2 - fileIn.position);
            _local8.uncompress();
      ...
      private static function getiTXt(param1:int, param2:int) : XML {
         ...
         if(_local9) {
            if(_local10 == 0) {
               ...
               _local11.writeBytes(fileIn,fileIn.position,param1 + param2 - fileIn.position);
               _local11.uncompress();
               _local7 = _local11.readUTFBytes(_local11.length);
            }
         } else {
            _local7 = fileIn.readUTFBytes(param1 + param2 - fileIn.position);
         }
         _local3.appendChild(<keyword>{_local4}</keyword>);
         _local3.appendChild(<text>{_local7}</text>);
         _local3.appendChild(<languageTag>{_local5}</languageTag>);
         _local3.appendChild(<translatedKeyword>{_local6}</translatedKeyword>);
         return _local3;
      }
