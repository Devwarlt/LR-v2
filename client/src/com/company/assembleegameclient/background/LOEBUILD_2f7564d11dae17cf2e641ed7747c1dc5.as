...
public class LOEBUILD_2f7564d11dae17cf2e641ed7747c1dc5 extends Background {

      public var stars_:Vector.<Star>;

      protected var graphicsData_:Vector.<IGraphicsData>;

      public function LOEBUILD_2f7564d11dae17cf2e641ed7747c1dc5() {
...
class Star {
   ...
   public function draw(param1:Vector.<IGraphicsData>, param2:Camera, param3:int) : void {
      var _local4:Number = this.x_ * Math.cos(-param2.angleRad_) - this.y_ * Math.sin(-param2.angleRad_);
      var _local5:Number = this.x_ * Math.sin(-param2.angleRad_) + this.y_ * Math.cos(-param2.angleRad_);
