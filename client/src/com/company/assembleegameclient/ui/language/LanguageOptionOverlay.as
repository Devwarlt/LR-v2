...
public class LanguageOptionOverlay extends ScreenBase {
      ...
      private function makeTitle() : TextFieldDisplayConcrete {
         ...
         _local1 = new TextFieldDisplayConcrete().setSize(36).setColor(16777215);
      ...
      private function makeDropDownLabel() : TextFieldDisplayConcrete {
         var _local1:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(16).setColor(11776947).setBold(true);
         _local1.setVerticalAlign(TextFieldDisplayConcrete.MIDDLE);
      ...
      private function makeLine() : Shape {
         ...
         _local1.graphics.lineStyle(1,6184542);
      ...
      public function clear() : void {
         if(Boolean(this.languageDropDown) && Boolean(contains(this.languageDropDown))) {
