...
public class EquipmentToolTip extends ToolTip {
      ...
      private static const MAX_WIDTH:int = 330;//230
      ...
      public function EquipmentToolTip(param1:int, param2:Player, param3:int, param4:String) {
         ...
         this.playerCanUse = !!param2?Boolean(LOEBUILD_efda783509bc93eea698457c87bbee3f.isUsableByPlayer(param1,param2)):false;
         var _local5:int = !!param2?int(LOEBUILD_efda783509bc93eea698457c87bbee3f.getMatchingSlotIndex(param1,param2)):-1;
         var _local6:uint = Boolean(this.playerCanUse) || this.player == null?uint(3552822):uint(6036765);
         var _local7:uint = Boolean(this.playerCanUse) || param2 == null?uint(10197915):uint(10965039);
         super(_local6,1,_local7,1,true);
         this.slotTypeToTextBuilder = new SlotComparisonFactory();
         this.objectXML = LOEBUILD_efda783509bc93eea698457c87bbee3f.xmlLibrary_[param1];
         ...
         if(this.player == null) {
            ...
            if(this.player.equipment_[_local5] != -1) {
               this.curItemXML = LOEBUILD_efda783509bc93eea698457c87bbee3f.xmlLibrary_[this.player.equipment_[_local5]];
            }
         }
         this.addIcon();
         this.addTitle();
      ...
      private function makeItemPowerText() : void {
         ...
         if(this.objectXML.hasOwnProperty("feedPower")) {
            _local1 = Boolean(this.playerCanUse) || this.player == null?16777215:16549442;
      ...
      private function addUniqueEffectsToList() : void {
         ...
         if(this.objectXML.hasOwnProperty("ExtraTooltipData")) {
            ...
            for each(_local2 in _local1) {
               ...
               _local5 = Boolean(_local3) && Boolean(_local4)?": ":"\n";
      ...
      private function isEmptyEquipSlot() : Boolean {
         return Boolean(this.isEquippable) && this.curItemXML == null;
      }

      private function addIcon() : void {
         var _local1:XML = LOEBUILD_efda783509bc93eea698457c87bbee3f.xmlLibrary_[this.objectType];
         var _local2:int = 5;
         ...
         var _local3:BitmapData = LOEBUILD_efda783509bc93eea698457c87bbee3f.getRedrawnTextureFromType(this.objectType,60,true,true,_local2);
      ...
      private function addTierText() : void {
         ...
         var _local5:* = this.objectXML.hasOwnProperty("Ensign") == true;
         ...
         if(Boolean(_local5)) {
            ...
            if(this.objectXML.hasOwnProperty("@starBlue")) {
                this.tierText.setColor(2003199);
                this.tierText.setStringBuilder(new StaticStringBuilder("E--"));
            } else if(this.objectXML.hasOwnProperty("@starRed")) {
                this.tierText.setColor(16724016);
                this.tierText.setStringBuilder(new StaticStringBuilder("E-"));
            } else if(this.objectXML.hasOwnProperty("@starOrange")) {
                this.tierText.setColor(16753920);
                this.tierText.setStringBuilder(new StaticStringBuilder("E"));
            } else if(this.objectXML.hasOwnProperty("@starYellow")) {
                this.tierText.setColor(15658496);
                this.tierText.setStringBuilder(new StaticStringBuilder("E+"));
            } else if(this.objectXML.hasOwnProperty("@starWhite")) {
                this.tierText.setColor(16774638);
                this.tierText.setStringBuilder(new StaticStringBuilder("E++"));
            } else {
            ...
            addChild(this.tierText);
             ...
             } else if(this.objectXML.hasOwnProperty("@blackBag")) {
                 this.tierText.setColor(16728128);
                 this.tierText.setStringBuilder(new StaticStringBuilder("LT"));
             } else if(this.objectXML.hasOwnProperty("@superBag")) {
                 this.tierText.setColor(16776960);
                 this.tierText.setStringBuilder(new StaticStringBuilder("SRT"));
             } else if(this.objectXML.hasOwnProperty("@ultraBag")) {
                 this.tierText.setColor(12500670);
                 this.tierText.setStringBuilder(new StaticStringBuilder("ULTIMATE"));
             } else {
                 this.tierText.setColor(9055202);
                 this.tierText.setStringBuilder(new LineBuilder().setParams(TextKey.UNTIERED_ABBR));
             }
      ...
      private function addTitle() : void {
         var _local1:int = Boolean(this.playerCanUse) || this.player == null?16777215:16549442;
         ...
         this.titleText.setStringBuilder(new LineBuilder().setParams(LOEBUILD_efda783509bc93eea698457c87bbee3f.typeToDisplayId_[this.objectType]));
      ...
      private function buildUniqueTooltipData() : String {
         var _local1:XMLList = null;
         var _local2:Vector.<Effect> = null;
      ...
      private function makeEffectsList() : void {
         var _local1:AppendingLineBuilder = null;
         if(this.effects.length != 0 || this.comparisonResults.lineBuilder != null || Boolean(this.objectXML.hasOwnProperty("ExtraTooltipData"))) {
      ...
      private function appendEffects(param1:Vector.<Effect>, param2:AppendingLineBuilder) : void {
         ...
         for each(_local3 in param1) {
            ...
            param2.pushParams(_local3.name_,_local3.getValueReplacementsWithColor(),_local4,_local5);
         }
      }

      private function addNumProjectilesTagsToEffectsList() : void {
         if(Boolean(this.objectXML.hasOwnProperty("NumProjectiles")) && this.comparisonResults.processedTags.hasOwnProperty(this.objectXML.NumProjectiles.toXMLString()) != true) {
      ...
      private function addFameBonusTagToEffectsList() : void {
         ...
         if(this.objectXML.hasOwnProperty("FameBonus")) {
            ...
            _local2 = !!this.playerCanUse?uint(TooltipHelper.BETTER_COLOR):uint(TooltipHelper.NO_DIFF_COLOR);
            if(this.curItemXML != null && Boolean(this.curItemXML.hasOwnProperty("FameBonus"))) {
      ...
      private function addMpCostTagToEffectsList() : void {
         ...
         } else if(Boolean(this.objectXML.hasOwnProperty("MpCost")) && !this.comparisonResults.processedTags[this.objectXML.MpCost[0].toXMLString()]) {
      ...
      private function addProjectileTagsToEffectsList() : void {
         ...
         if(Boolean(this.objectXML.hasOwnProperty("Projectile")) && !this.comparisonResults.processedTags.hasOwnProperty(this.objectXML.Projectile.toXMLString())) {
      ...
      private function addActivateTagsToEffectsList() : void {
         ...
         var _local31:AppendingLineBuilder = null;
      ...
      private function getEffectTag(param1:XML, param2:String) : XML {
         ...
         matches = xml.Activate.(text() == "GenericActivate");
      ...
      private function getStatTag(param1:XML, param2:String) : XML {
         ...
         matches = xml.Activate.(text() == "StatBoostAura");
         for each(tag in matches) {
      ...
      private function getComparedStatText(param1:XML) : Object {
         var _local2:int = int(param1.@stat);
         var _local3:int = int(param1.@amount);
      ...
      private function addEquipmentItemRestrictions() : void {
         if(this.objectXML.hasOwnProperty("Treasure") == false) {
            ...
            if(Boolean(this.isInventoryFull) || this.inventoryOwnerType == LOEBUILD_420e0eb99409a66597f19d612d12594f.CURRENT_PLAYER) {
      ...
      private function makeRestrictionList() : void {
         ...
         if(Boolean(this.objectXML.hasOwnProperty("VaultItem")) && Boolean(this.invType != -1) && this.invType != LOEBUILD_efda783509bc93eea698457c87bbee3f.idToType_["Vault Chest"]) {
            this.restrictions.push(new Restriction(TextKey.STORE_IN_VAULT,16549442,true));
         }
         if(this.objectXML.hasOwnProperty("Umbral")) {
            this.restrictions.push(new Restriction(TextKey.UMBRAL_ITEM,2003199,false));
         }
          if(this.objectXML.hasOwnProperty("Legacy")) {
              this.restrictions.push(new Restriction(TextKey.EPIC_STUFF,16776960,false));
          }
         ...
         var _local1:Vector.<String> = LOEBUILD_efda783509bc93eea698457c87bbee3f.usableBy(this.objectType);
         if(_local1 != null) {
         ...
         for each(_local2 in this.objectXML.EquipRequirement) {
            _local3 = LOEBUILD_efda783509bc93eea698457c87bbee3f.playerMeetsRequirement(_local2,this.player);
            if(_local2.toString() == "Stat") {
               _local4 = int(_local2.@stat);
               _local5 = int(_local2.@value);
               this.restrictions.push(new Restriction("Requires " + StatData.statToName(_local4) + " of " + _local5,!!_local3?uint(11776947):uint(16549442),!!_local3?false:true));
            }
         }
      }
      ...
      private function buildRestrictionsLineBuilder() : StringBuilder {
         ...
         for each(_local2 in this.restrictions) {
            ...
            _local5 = !!this.player?LOEBUILD_efda783509bc93eea698457c87bbee3f.typeToDisplayId_[this.player.objectType_]:"";
            _local1.pushParams(_local2.text_,{
               "unUsableClass":_local5,
               "usableClasses":this.getUsableClasses(),
               "keyCode":KeyCodes.CharCodeStrings[LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.data_.useSpecial]
            },_local3,_local4);
         }
         return _local1;
      }
      ...
      private function modifyWisModStat(param1:String, param2:Number = 1) : String {
         ...
         if(_local4 < 30) {
            ...
            _local5 = Number(param1);
            _local6 = _local5 < 0?-1:1;
            _local7 = _local5 * _local4 / 150 + _local5 * _local6;
            _local7 = Math.floor(_local7 * Math.pow(10,param2)) / Math.pow(10,param2);
            if(_local7 - int(_local7) * _local6 >= 1 / Math.pow(10,param2) * _local6) {
