...
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.ArenaPortal;
...
public class ArenaPortalPanel extends Panel {
      ...
      public function ArenaPortalPanel(param1:LOEBUILD_6615c4f9bea4fdaf620bf1ad513a54c1, param2:ArenaPortal) {
      ...
      private function makeTitle() : StaticTextDisplay {
         ...
         _local1.setSize(18).setColor(16777215).setTextWidth(WIDTH).setWordWrap(true).setMultiLine(true).setAutoSize(TextFieldAutoSize.CENTER).setBold(true).setHTML(true);
