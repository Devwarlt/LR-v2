...
public class AccountLoadingScreen extends Sprite {
      ...
      public function AccountLoadingScreen() {
         ...
         this.loadingText_ = new TextFieldDisplayConcrete().setSize(30).setColor(16777215).setBold(false);
         this.loadingText_.setStringBuilder(new LineBuilder().setParams(TextKey.LOE_WELCOME));
