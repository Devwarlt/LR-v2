...
public class AnimatedChar {
      ...
      public function AnimatedChar(param1:MaskedImage, param2:int, param3:int, param4:int) {
         ...
         _local6.addFromMaskedImage(param1,param2,param3);
         if(param4 == RIGHT) {
      ...
      public function imageFromDir(param1:int, param2:int, param3:Number) : MaskedImage {
         var _local4:Vector.<MaskedImage> = this.dict_[param1][param2];
         param3 = Math.max(0,Math.min(0.99999,param3));
         var _local5:int = param3 * _local4.length;
         return _local4[_local5];
      }

      public function imageFromAngle(param1:Number, param2:int, param3:Number) : MaskedImage {
         var _local4:int = int(param1 / PIOVER4 + 4) % 8;
         ...
         var _local7:Vector.<MaskedImage> = _local6[param2];
         param3 = Math.max(0,Math.min(0.99999,param3));
         var _local8:int = param3 * _local7.length;
         return _local7[_local8];
      }

      public function imageFromFacing(param1:Number, param2:Camera, param3:int, param4:Number) : MaskedImage {
         var _local5:Number = Trig.boundToPI(param1 - param2.angleRad_);
         ...
         var _local9:Vector.<MaskedImage> = _local8[param3];
         param4 = Math.max(0,Math.min(0.99999,param4));
         var _local10:int = param4 * _local9.length;
      ...
      private function loadDir(param1:int, param2:Boolean, param3:Boolean, param4:MaskedImageSet) : Dictionary {
         var _local14:Vector.<MaskedImage> = null;
         var _local15:BitmapData = null;
         var _local16:BitmapData = null;
         var _local5:Dictionary = new Dictionary();
         var _local6:MaskedImage = param4.images_[param1 + 0];
         var _local7:MaskedImage = param4.images_[param1 + 1];
         var _local8:MaskedImage = param4.images_[param1 + 2];
         if(_local8.amountTransparent() == 1) {
            _local8 = null;
         }
         var _local9:MaskedImage = param4.images_[param1 + 4];
         var _local10:MaskedImage = param4.images_[param1 + 5];
         ...
         var _local11:MaskedImage = param4.images_[param1 + 6];
         ...
         _local12.push(!!param2?_local6.mirror():_local6);
         _local5[STAND] = _local12;
         var _local13:Vector.<MaskedImage> = new Vector.<MaskedImage>();
         _local13.push(!!param2?_local7.mirror():_local7);
         if(_local8 != null) {
            _local13.push(!!param2?_local8.mirror():_local8);
         } else if(param3) {
            _local13.push(!param2?_local7.mirror(7):_local7);
         } else {
            _local13.push(!!param2?_local6.mirror():_local6);
         }
         ...
         if(_local9 == null && _local10 == null) {
            ...
            if(_local9 != null) {
               _local14.push(!!param2?_local9.mirror():_local9);
            }
            if(_local10 != null) {
               _local14.push(!!param2?_local10.mirror():_local10);
            }
         }
