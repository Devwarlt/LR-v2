...
public class ConditionEffect {
      ...
      public static function getConditionEffectIcons(param1:uint, param2:Vector.<BitmapData>, param3:int) : void {
         ...
         while(param1 != 0) {
            _local4 = param1 & param1 - 1;
            _local5 = param1 ^ _local4;
            _local6 = getIconsFromBit(_local5);
            if(_local6 != null) {
               param2.push(_local6[param3 % _local6.length]);
            }
            param1 = _local4;
         }
      }
      ...
      public static function addConditionEffectIcon(param1:Vector.<BitmapData>, param2:int, param3:Boolean) : void {
         ...
         if(effectIconCache[param2]) {
            ...
            if(param3) {
               ...
               _local4.draw(AssetLibrary.getImageFromSet("lofiInterfaceBig",param2),_local6);
            } else {
               _local4 = new BitmapDataSpy(16,16,true,0);
               _local4.draw(AssetLibrary.getImageFromSet("lofiInterface2",param2),_local5);
            }
            _local4 = GlowRedrawer.outlineGlow(_local4,4294967295);
            _local4.applyFilter(_local4,_local4.rect,PointUtil.ORIGIN,GLOW_FILTER);
            effectIconCache[param2] = _local4;
         }
         param1.push(_local4);
      }
      ...
      private static function getIconsFromBit(param1:uint) : Vector.<BitmapData> {
         ...
         var _local3:uint = 0;
         var _local4:Vector.<BitmapData> = null;
         var _local5:int = 0;
            ...
            while(_local3 < 32) {
               ...
               if(effects_[_local3].iconOffsets_ != null) {
                  ...
                  while(_local5 < effects_[_local3].iconOffsets_.length) {
                     ...
                     _local6 = GlowRedrawer.outlineGlow(_local6,4294967295);
            ...
            while(_local6 < effects_.length) {
               ...
               if(effects_[_local6].iconOffsets_ != null) {
                  ...
                  while(_local7 < effects_[_local6].iconOffsets_.length) {
                     ...
                     _local3 = GlowRedrawer.outlineGlow(_local3,4294967295);
