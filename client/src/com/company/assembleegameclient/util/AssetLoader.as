...
import com.company.assembleegameclient.LOEBUILD_5891da2d64975cae48d175d1e001f5da.particles.ParticleLibrary;
...
public class AssetLoader {
      ...
      public function load() : void {
         ...
         LOEBUILD_3225a10b07f1580f10dee4abc3779e6c.load();
      ...
      private function addImages() : void {
         ...
         AssetLibrary.addImageSet("lofiObjLoEItems16x16",new EmbeddedAssets.lofiObjLoEItems16x16Embed_().bitmapData,16,16);
      ...
      private function parse3DModels() : void {
         ...
         for(_local1 in EmbeddedAssets.models_) {
            ...
            LOEBUILD_1cd204050ec7f52020766f99b3129701.parse3DOBJ(_local1,_local2);
            LOEBUILD_1cd204050ec7f52020766f99b3129701.parseFromOBJ(_local1,_local3);
         }
      }
      ...
      private function parseGroundFiles() : void {
         ...
         for each(_local1 in EmbeddedData.groundFiles) {
            LOEBUILD_0bd5afc531164aa9bf1c5f132d4a86a5.parseFromXML(XML(_local1));
         }
      }
      ...
      private function parseObjectFiles() : void {
         ...
         for each(_local1 in EmbeddedData.objectFiles) {
            ...
            LOEBUILD_efda783509bc93eea698457c87bbee3f.parseFromXML(XML(_local1));
         }
      ...
      private function parseRegionFiles() : void {
         ...
         for each(_local1 in EmbeddedData.regionFiles) {
            LOEBUILD_bc44e55f2b7833506dc8a2b0246803f4.parseFromXML(XML(_local1));
         }
      }
