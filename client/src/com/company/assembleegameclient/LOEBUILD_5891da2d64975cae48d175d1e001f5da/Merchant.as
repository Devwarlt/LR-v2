...
public class Merchant extends LOEBUILD_4f1c60f303d750123192c52bfb412b04 implements LOEBUILD_5e926ae2981199c65b99066bd9e14d29 {
      ...
      override public function soldObjectName() : String {
         return LOEBUILD_efda783509bc93eea698457c87bbee3f.typeToDisplayId_[this.merchandiseType_];
      }

      override public function soldObjectInternalName() : String {
         var _local1:XML = LOEBUILD_efda783509bc93eea698457c87bbee3f.xmlLibrary_[this.merchandiseType_];
         return _local1.@id.toString();
      }

      override public function getTooltip() : ToolTip {
         var _local1:ToolTip = new EquipmentToolTip(this.merchandiseType_,map_.player_,-1,LOEBUILD_420e0eb99409a66597f19d612d12594f.NPC);
         return _local1;
      }
      ...
      override public function getIcon() : BitmapData {
         var _local3:BaseSimpleText = null;
         var _local1:BitmapData = LOEBUILD_efda783509bc93eea698457c87bbee3f.getRedrawnTextureFromType(this.merchandiseType_,80,true);
         var _local2:XML = LOEBUILD_efda783509bc93eea698457c87bbee3f.xmlLibrary_[this.merchandiseType_];
         if(_local2.hasOwnProperty("Doses")) {
            _local1 = _local1.clone();
            _local3 = new BaseSimpleText(12,16777215,false,0,0);
      ...
      public function getTex1Id(param1:int) : int {
         ...
         if(_local2.Activate == "Dye" && Boolean(_local2.hasOwnProperty("Tex1"))) {
      ...
      public function getTex2Id(param1:int) : int {
         ...
         if(_local2.Activate == "Dye" && Boolean(_local2.hasOwnProperty("Tex2"))) {
      ...
      override protected function getTexture(param1:Camera, param2:int) : BitmapData {
         ...
         var _local3:BitmapData = LOEBUILD_efda783509bc93eea698457c87bbee3f.getRedrawnTextureFromType(this.merchandiseType_,size_,false,false);
         if(this.alpha_ != 1) {
      ...
      public function setMerchandiseType(param1:int) : void {
         ...
         this.merchandiseTexture_ = LOEBUILD_efda783509bc93eea698457c87bbee3f.getRedrawnTextureFromType(this.merchandiseType_,100,false);
      }
   }
}
