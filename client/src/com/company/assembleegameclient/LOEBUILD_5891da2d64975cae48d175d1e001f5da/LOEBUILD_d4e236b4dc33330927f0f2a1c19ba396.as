...
public class LOEBUILD_d4e236b4dc33330927f0f2a1c19ba396 extends GameObject {
      ...
      public function LOEBUILD_d4e236b4dc33330927f0f2a1c19ba396(param1:XML) {
      ...
      override public function draw(param1:Vector.<IGraphicsData>, param2:Camera, param3:int) : void {
         ...
         while(_local5 < this.faces_.length) {
            ...
            if(_local8 == null || _local8.texture_ == null || _local8 != null && _local8.obj_ is LOEBUILD_d4e236b4dc33330927f0f2a1c19ba396 && !_local8.obj_.dead_) {
      ...
      private function addWall(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number) : void {
         var _local7:Vector.<Number> = new <Number>[param1,param2,param3,param4,param5,param6,param4,param5,param6 - 2,param1,param2,param3 - 2];
         var _local8:LOEBUILD_f09b627d212c86ff198f3f77f532cdf5 = new LOEBUILD_f09b627d212c86ff198f3f77f532cdf5(texture_,_local7,UVTHEIGHT,true,true);
