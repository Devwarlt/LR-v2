...
//        //Created in order to stop PetRisingFury from breaking and certain legendaries.
//        public static IEnumerable<Entity> GetNearestEntitieIsGroup(this Entity entity, double dist, string group)
//        {
