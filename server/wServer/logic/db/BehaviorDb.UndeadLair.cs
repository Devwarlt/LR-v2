    ...
    partial class BehaviorDb
    {
        private _ UndeadLair = () => Behav()
            .Init("Septavius the Ghost God",
                ...
                new MostDamagers(3,
                    new OnlyOne(
                        new ItemLoot("Doom Bow", whitebag),
                        new ItemLoot("Bow of the Morning Star", whitebag),
                        new ItemLoot("Bow of the Ancient Star", blackbag),
                        new ItemLoot("Doom Bow of Evil", blackbag)
                        ),
