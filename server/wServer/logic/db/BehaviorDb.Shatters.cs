...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        #region mobs
            .Init("shtrs blobomb maker",
                new State(
                    ...
                    new State("Spawn",
                        new EntityNotExistsTransition("shtrs Bridge Sentinel", 10, "Default"),
                        //new Spawn("shtrs Blobomb", maxChildren: 4, initialSpawn: 4, coolDown: 2000),
                        new TossObject("shtrs Blobomb", 3, 0, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 3, 45, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 3, 90, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 3, 135, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 3, 180, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 3, 225, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 3, 270, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 3, 315, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 3, 245, coolDown: 4000),
                        new InvisiToss("shtrs Blobomb", 3, 100, coolDown: 4000),
                        new InvisiToss("shtrs Blobomb", 3, 300, coolDown: 8000)
                        //new TimedTransition(18000, "suicide")
                        //new EntityNotExistsTransition("shtrs Bridge Sentinel", 999, "suicide")
                        ),
                    new State("suicide",
                        new Suicide()
                        )
        ...
        .Init("shtrs Lava Souls",
            ...
            new State(
                new State("Main",
                    ...
                    new Spawn("shtrs Ice Portal", maxChildren: 1, initialSpawn: 1, coolDown: 10000)
            ...
            new State(
                new State("Main",
                    ...
                    new Shoot(10, 1, projectileIndex: 0, coolDown: 100, predictive: 1),
                    new Shoot(10, 3, projectileIndex: 1, shootAngle: 10, coolDown: 4000, predictive: 1),
                    new Spawn("shtrs Fire Portal", maxChildren: 1, initialSpawn: 1, coolDown: 15000)
                    //new TimedTransition(2500, "Throw")
                ),
                new State("Throw",
        ...
        #region portals
            ...
            .Init("shtrs Ice Shield",
                new State(
                    ...
                    new State(
                        new Orbit(0.25, 2, target: "shtrs Ice Mage"),
                        new Charge(2, 7, coolDown: 5000),
                        new Shoot(3, 6, 60, projectileIndex: 0, fixedAngle: 0, coolDown: 3600),
                        new Shoot(3, 6, 60, projectileIndex: 0, fixedAngle: 10, coolDown: 3600, coolDownOffset: 600),
                        new Shoot(3, 6, 60, projectileIndex: 0, fixedAngle: 20, coolDown: 3600, coolDownOffset: 1200),
                        new Shoot(3, 6, 60, projectileIndex: 0, fixedAngle: 30, coolDown: 3600, coolDownOffset: 1800),
                        new Shoot(3, 6, 60, projectileIndex: 0, fixedAngle: 40, coolDown: 3600, coolDownOffset: 2400),
                        new Shoot(3, 6, 60, projectileIndex: 0, fixedAngle: 50, coolDown: 3600, coolDownOffset: 3000)
                    ),
                    new State("Death",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
            ...
            new State(
                ...
                new State(
                    new Orbit(0.5, 5, target:"shtrs Twilight Archmage"),
                    new Charge(1, 7, coolDown: 10000),
                    new Shoot(13, 10, 8, projectileIndex: 0, coolDown: 1000, predictive:1/*, fixedAngle: 1*/)
                ),
            new State("Death",
                new ConditionalEffect(ConditionEffectIndex.Invincible),
        ...
        #region first boss
            ...
            .Init("shtrs Bridge Sentinel",
                new State(
                    new Shoot(2, projectileIndex: 5, count: 3, fixedAngle: 0, coolDown: 1000),
                    new Shoot(2, projectileIndex: 5, count: 3, fixedAngle: 45, coolDown: 1000),
                    new Shoot(2, projectileIndex: 5, count: 3, fixedAngle: 90, coolDown: 1000),
                    new Shoot(2, projectileIndex: 5, count: 3, fixedAngle: 135, coolDown: 1000),
                    new Shoot(2, projectileIndex: 5, count: 3, fixedAngle: 180, coolDown: 1000),
                    new HpLessTransition(0.2, "Death"),
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new PlayerWithinTransition(21, "Close Bridge2")
                        ),
                    /*new State("Close Bridge",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shtrs Bridge Closer", "Closer"),
                        new TimedTransition(7500, "Close Bridge2")
                        ),*/
                    new State("Close Bridge2",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shatters bridge closer 2", "Closer"),
                        new TimedTransition(3000, "Close Bridge3")
                        ),
                    new State("Close Bridge3",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shatters bridge closer 3", "Closer"),
                        new TimedTransition(3000, "Close Bridge4")
                        ),
                    new State("Close Bridge4",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shatters bridge closer 4", "Closer"),
                        new TimedTransition(3000, "Close Bridge5")
                        ),
                    new State("Close Bridge5",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shatters bridge closer 5", "Closer"),
                        new TimedTransition(3000, "Close Bridge6")
                        ),
                    new State("Close Bridge6",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shatters bridge closer 6", "Closer"),
                        new TimedTransition(7500, "Close Bridge7")
                        ),
                    new State("Close Bridge7",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shatters bridge closer 7", "Closer"),
                        new TimedTransition(3000, "Close Bridge8")
                        ),
                    new State("Close Bridge8",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shatters bridge closer 8", "Closer"),
                        new TimedTransition(3000, "Close Bridge9")
                        ),
                    new State("Close Bridge9",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shatters bridge closer 9", "Closer"),
                    ...
                    new State("BEGIN",
                        ...
                        new Timed(2100, new Shoot(15, 15, 12, projectileIndex: 0, fixedAngle: 179, coolDown: 700, coolDownOffset: 3000)),
                        ...
                        new State("Swirl Shot",
                            ...
                            new Taunt("CONSUME!"),
                            new Order(20, "shatters blobomb maker", "Spawn"),
                            ...
                            new Shoot(15, 15, 11, projectileIndex: 0, fixedAngle: 179, coolDown: 700, coolDownOffset: 700),
                                    new State("Swirl1_2",
                            new Shoot(50, projectileIndex: 0, count: 1, shootAngle: 102, fixedAngle: 102, coolDown: 6000),
                            new Shoot(50, projectileIndex: 0, count: 1, shootAngle: 114, fixedAngle: 114, coolDown: 6000, coolDownOffset: 200),
                            new Shoot(50, projectileIndex: 0, count: 1, shootAngle: 126, fixedAngle: 126, coolDown: 6000, coolDownOffset: 400),
                        ...
                        new State("Death",
                            ...
                            new Order(1, "shatters chest spawner 1", "Open"),
                            new Order(46, "shatters spawn bridge", "Open"),
                            new Order(20, "shatters blobomb maker", "suicide"),
                ...
                new State(
                    ...
                    new State("Wake",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            ...
                            new TimedTransition(1000, "TossShit")
                        )
                    ),
                    new State("TossShit",
                        ...
                        new TimedTransition(30000, "Shoot")
                        ),
                  new State("Shoot",
                    ...
                    new State("Pre Birds",
                        ...
                        new Order(50, "shtrs MagiGenerators", "remdef"),
                        new TimedTransition(2000, "Birds")
                        ),
                    new State("Birds",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(20, "shtrs Blizzard", "orbit"),
                        ...
                        new EntitiesNotExistsTransition(100, "PreNewShit2", "shtrs Inferno", "shtrs Blizzard")
                        ),
                    new State("PreNewShit2",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(50, "shtrs MagiGenerators", "Main"),
                        new TimedTransition(6000, "NewShit2")
                        ),
                    new State("NewShit2",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(0, -6, 1),
                        new TimedTransition(6000, "Active2")
                        ),
                    new State("Active2",
                    ...
                    new State("NewShit4",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(0, 13, 1),
                        new TimedTransition(6000, "Active4")
                            ),
                    new State("Active4",
                        new Taunt("THE POWER...IT CONSUMES ME!"),
                        new Shoot(15, 20, projectileIndex: 2, coolDown: 100000000, coolDownOffset: 100),
                    ...
                    new State("NewShit5",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(-4, 0, 1),
                        new TimedTransition(6000, "Active5")
                            ),
                    new State("Active5",
                        new Taunt("THE POWER...IT CONSUMES ME!"),
                        new Shoot(15, 20, projectileIndex: 2, coolDown: 100000000, coolDownOffset: 100),
                    ...
                    new State("NewShit6",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(-4, 0, 1),
                        new TimedTransition(6000, "Active6")
                            ),
                    new State("Active6",
                        new Taunt("THE POWER...IT CONSUMES ME!"),
                        new Shoot(15, 20, projectileIndex: 2, coolDown: 100000000, coolDownOffset: 100),
                    ...
                    new State("NewShit7",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(0, -13, 1),
                        new TimedTransition(6000, "Active7")
                            ),
                    new State("Active7",
                        new Taunt("THE POWER...IT CONSUMES ME!"),
                        new Shoot(15, 20, projectileIndex: 2, coolDown: 100000000, coolDownOffset: 100),
                        ...
                        new State("Death",
                            ...
                            new Order(1, "shatters chest spawner 2", "Open"),
                            new TimedTransition(2000, "Suicide")
                            ),
                        new State("Suicide",
                            new Shoot(35, projectileIndex: 0, count: 30),
        ...
        #region birds
            .Init("shtrs Inferno",
                new State(
                    ...
                    new State("normal",
                        new EntityNotExistsTransition("shtrs Blizzard", 45, "sblizzard"),
                        ...
                        new Shoot(0, projectileIndex: 1, count: 10, shootAngle: 36, fixedAngle: 90, coolDown: 4000)
                        ),
                    new State("sblizzard",
                        new Follow(1, 10, 10),
                        new ChangeSize(35, 200),
                        new Charge(1.5, coolDown: 6500),
                        new Flash(0xfFF0000, 0.25, 9000001),
                        new Shoot(0, projectileIndex: 0, count: 12, shootAngle: 30, fixedAngle: 15, coolDown: 4333),
                        new Shoot(0, projectileIndex: 0, count: 6, shootAngle: 60, fixedAngle: 30, coolDown: 3500),
                        new Shoot(0, projectileIndex: 0, count: 6, shootAngle: 60, fixedAngle: 60, coolDown: 7250),
                        new Shoot(0, projectileIndex: 0, count: 6, shootAngle: 60, fixedAngle: 90, coolDown: 10000),
                        new Shoot(0, projectileIndex: 1, count: 20, shootAngle: 18, fixedAngle: 90, coolDown: 4000)
                        )
                )
            )
            ...
            .Init("shtrs Blizzard",
                new State(
                    ...
                    new State("orbit",
                        new Orbit(0.5, 6, target: "Shtrs Twilight Archmage"),
                        new Shoot(0, projectileIndex: 0, count: 4, shootAngle: 90, fixedAngle: 45, coolDown: 25),
                        new TimedTransition(7000, "Spin2")
                        ),
                    new State("Spin2",
        ...
        #region 1stbosschest
            .Init("shtrs Loot Balloon Bridge",
                new State(
                    new HpLessTransition(0.1, "deathchest"),
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new TimedTransition(5000, "Bridge")
                    ),
                    new State("deathchest",
                        new Suicide()
                        ),
                    new State("Bridge",
                        new ThrowProjectile(0xbad, 4, 0, 5000),
                        new ThrowProjectile(0x5094, 4, 120, 5000),
                        new ThrowProjectile(0x233d, 4, 240, 5000)
                        )
                ),
                new MostDamagers(10,
                    new ItemLoot("Potion of Attack", 0.85),
                    new ItemLoot("Potion of Defense", 0.65),
                    new TierLoot(11, ItemType.Weapon, goodloot*1.5),
                    new TierLoot(12, ItemType.Weapon, greatloot*1.5),
                    new TierLoot(12, ItemType.Armor, goodloot*1.5),
                    new TierLoot(13, ItemType.Armor, greatloot*1.5),
                    new TierLoot(6, ItemType.Ability, greatloot*1.5),
                    new TierLoot(6, ItemType.Ring, greatloot*1.5)
                    ),
                new MostDamagers(5,
                    new OnlyOne(
                        new ItemLoot("Bracer of the Guardian", whitebag),
                        new ItemLoot("Ancient Bracer of the Guardian", blackbag),
                    ...
                    new TierLoot(7, ItemType.Ability, awesomeloot),
                    new TierLoot(7, ItemType.Ring, awesomeloot)
                    )
            )
        ...
        #region 2ndbosschest
            .Init("shtrs Loot Balloon Mage",
                new State(
                    ...
                    new State("Mage",
                        new ThrowProjectile(0xbac, 4, 0, 5000),
                        new ThrowProjectile(0x5095, 4, 90, 5000),
                        new ThrowProjectile(0x518c, 4, 180, 5000),
                        new ThrowProjectile(0x233d, 4, 270, 5000)
                        )
                ),
                new MostDamagers(10,
                    new ItemLoot("Potion of Mana", 0.85),
                    new TierLoot(11, ItemType.Weapon, goodloot*1.75),
                    new TierLoot(12, ItemType.Weapon, greatloot*1.75),
                    new TierLoot(12, ItemType.Armor, goodloot*1.75),
                    new TierLoot(13, ItemType.Armor, greatloot*1.75),
                    new TierLoot(6, ItemType.Ability, greatloot*1.75),
                    new TierLoot(6, ItemType.Ring, greatloot*1.75)
                    ),
                new MostDamagers(5,
                    new OnlyOne(
                        new ItemLoot("The Twilight Gemstone", whitebag),
                        new ItemLoot("The Ancient Twilight Gemstone", blackbag),
                        new ItemLoot("The Tower Tarot Card", awesomeloot),
                        //Twilight Archmage Set
                        new ItemLoot("Sentient Staff", awesomeloot),
                        new ItemLoot("Ancient Spell: Pierce", awesomeloot),
                        new ItemLoot("The Robe of Twilight", awesomeloot),
                        new ItemLoot("The Forgotten Ring", awesomeloot),
                        //Dark Knight Set
                        new ItemLoot("Broadsword of Bloodshed", awesomeloot),
                        new ItemLoot("Evil Shield of the Dark Knight", awesomeloot),
                        new ItemLoot("Chestguard of the Underworld", awesomeloot),
                        ...
                        new ItemLoot("Spiders Fang", awesomeloot),
                        //EPIC LOOT
                        new ItemLoot("Royal Blade", whitebag)
                        ),
                    new TierLoot(7, ItemType.Ability, awesomeloot*1.25),
                    new TierLoot(7, ItemType.Ring, awesomeloot*1.25)
                    )
            )
        ...
        #region BridgeStatues
            .Init("shtrs Bridge Obelisk A",
                new State(
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new EntityNotExistsTransition("shatters bridge closer 9", 100, "TALK")
                        ),
                    new State("TALK",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    ...
                    new State("Pause",
                        new HpLessTransition(0.35, "stageRage"),
                        new TimedTransition(7000, "Shoot")
                        ),
                    new State("stageRage",
                        new Spawn("shtrs Stone Knight", maxChildren: 1, initialSpawn: 1, coolDown: 50000),
                        new Spawn("shtrs Stone Mage", maxChildren: 1, initialSpawn: 1, coolDown: 75000),
                        new TimedTransition(7000, "ShootRage")
                        ),
                    new State("ShootRage",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new Shoot(0, projectileIndex: 0, count: 4, shootAngle: 90, fixedAngle: 45, coolDown: 10000),
                            ...
                            new Shoot(0, projectileIndex: 0, count: 4, shootAngle: 90, fixedAngle: 45, coolDown: 10000, coolDownOffset: 9800),
                            new Shoot(0, projectileIndex: 0, count: 4, shootAngle: 90, fixedAngle: 45, coolDown: 10000, coolDownOffset: 10000),
                            new TimedTransition(10000, "stageRage")
                        )
                    )
            )
            ...
            .Init("shtrs Bridge Obelisk C",                                                     //YELLOW TOWERS!
                new State(
                    new State("Idle",
                        ...
                        new EntityNotExistsTransition("shatters bridge closer 9", 100, "JustKillMe")
                        ),
                    ...
                    new State("stageRage",
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new Spawn("shtrs Stone Paladin", maxChildren: 1, initialSpawn: 1, coolDown: 175000),
                        new TimedTransition(7000, "ShootRage")
                        ),
                    new State("ShootRage",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
            ...
            .Init("shtrs Ice Mage",
                new State(
                    ...
                    new State("fire",
                        ...
                        new Spawn("shtrs Ice Shield", maxChildren: 1, initialSpawn: 1, coolDown: 10000)
                        //new TimedTransition(8000, "Spawn")
                        ),
                    new State("Spawn",
                        new Reproduce("shtrs Ice Shield", densityRadius: 12, densityMax: 1, spawnRadius: 1, coolDown: 10000),
                        //new Spawn("shtrs Ice Shield", maxChildren: 1, initialSpawn: 1, coolDown: 75000),
  ...
  //      )
        ...
        #region BUILD 2.00 NEW SHATTERS BEHAVIORS AND ID
            .Init("shatters wooden gate 2",
                new State(
                    new State("Idle",
                        new EntityNotExistsTransition("shtrs Abandoned Switch 2", 60, "Despawn")
                        ),
            ...
            .Init("shatters blobomb maker",
                new State(
                    ...
                    new State("Spawn",
                        ...
                        //new Spawn("shtrs Blobomb", maxChildren: 4, initialSpawn: 4, coolDown: 2000),
                        new TossObject("shtrs Blobomb", 3, 0, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 2, 45, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 2, 90, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 2, 135, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 2, 180, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 2, 225, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 2, 270, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 2, 315, coolDown: 9999999),
                        new InvisiToss("shtrs Blobomb", 1, 245, coolDown: 4000),
                        new InvisiToss("shtrs Blobomb", 1, 100, coolDown: 4000),
                        new InvisiToss("shtrs Blobomb", 1, 300, coolDown: 8000)
                        //new TimedTransition(18000, "suicide")
                        //new EntityNotExistsTransition("shtrs Bridge Sentinel", 999, "suicide")
                        ),
                    new State("suicide",
        ...
        #region 3rdboss
            .Init("shtrs The Forgotten King",
                new State(
                    ...
                    new State("red",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Stasis),
                            new MoveTo(0, 8, 0.5),
                            new TimedTransition(15000, "J Guardians")
                            ),
                        ...
                        new State("littlerage",
                            //new ChangeSize(100, 180),//was 330
                            new Shoot(10, 1, projectileIndex: 2, coolDown: 10),
                            new Shoot(10, 1, projectileIndex: 3, coolDown: 10),
                            new TimedTransition(8500, "Shoot1")
                            ),
                        new State("Shoot1",
                            new Shoot(10, 1, projectileIndex: 2, coolDown: 10),
                            new Shoot(10, 1, projectileIndex: 3, coolDown:10),
                            new TimedTransition(500, "Shoot2")
                            ),
                        new State("Shoot2",
                            new Shoot(10, 1, projectileIndex: 2, coolDown: 10),
                            new Shoot(10, 1, projectileIndex: 3, coolDown: 10),
                            new TimedTransition(500, "Shoot3")
                            ),
                        new State("Shoot3",
                            new Shoot(10, 1, projectileIndex: 2, coolDown: 10),
                            new Shoot(10, 1, projectileIndex: 3, coolDown: 10),
                            new TimedTransition(500, "Shoot4")
                            ),
                        new State("Shoot4",
                            new Shoot(10, 1, projectileIndex: 2, coolDown: 10),
                            new Shoot(10, 1, projectileIndex: 3, coolDown: 10),
                            new TimedTransition(500, "Raged1")
                            ),
                        new State("Raged1",
                            ...
                            new HpLessTransition(0.7, "MoveTo"),
                        ...
                        new State("MoveTo",
                            new ConditionalEffect(ConditionEffectIndex.Invincible),
                            new MoveTo(0, -8, 0.5),
                            new TimedTransition(18000, "God")
                            ),
                        new State("God",
                            new Taunt("YOU TEST THE PATIENCE OF A GOD! TENTACLES OF WRATH..."),
                            new ConditionalEffect(ConditionEffectIndex.Invincible),
                        ...
                        new State("Hahaha",
                            ...
                            new Shoot(10, 1, projectileIndex: 3, coolDown: 10),
                            //shtrs Lava Souls
                            new TossObject("shtrs Lava Souls", 7, 0, coolDown: 9999999),
                            new InvisiToss("shtrs Lava Souls", 7, 45, coolDown: 9999999),
                            new InvisiToss("shtrs Lava Souls", 7, 90, coolDown: 9999999),
                            new InvisiToss("shtrs Lava Souls", 7, 135, coolDown: 9999999),
                            new InvisiToss("shtrs Lava Souls", 7, 180, coolDown: 9999999),
                            new InvisiToss("shtrs Lava Souls", 7, 225, coolDown: 9999999),
                            new InvisiToss("shtrs Lava Souls", 7, 270, coolDown: 9999999),
                            new InvisiToss("shtrs Lava Souls", 7, 315, coolDown: 9999999),
                            new InvisiToss("shtrs Lava Souls", 7, 245, coolDown: 4000),
                            new InvisiToss("shtrs Lava Souls", 7, 100, coolDown: 4000),
                            new InvisiToss("shtrs Lava Souls", 7, 300, coolDown: 8000),
                            new TimedTransition(45000, "God")
                            ),
                        new State("Death",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new CopyDamageOnDeath("shtrs Loot Balloon King"),
                            new Order(1, "shatters chest spawner 3", "Open"),
                            new Taunt("Impossible..........IMPOSSIBLE!"),
                            //new Spawn("shtrs Ice Shield", maxChildren: 2, initialSpawn: 2, coolDown: 2000),
                            new Spawn("shtrs Ice Portal", maxChildren: 1, initialSpawn: 1, coolDown: 2000),
                            new Spawn("shtrs Fire Portal", maxChildren: 1, initialSpawn: 1, coolDown: 2000),
            ...
            .Init("shtrs Royal Guardian J",
                new State(
                    new State("shoot",
                        new Orbit(0.25, 2, 5, "shtrs The Forgotten King"),
            ...
            .Init("shtrs Green Crystal",
                new State(
                    new SpecificHeal(25, 5000, "Crystals", 10000),
                    new Prioritize(
                        new StayAbove(1.2, 160),
                        new Protect(2, "shtrs The Forgotten King", 30, 10, reprotectRange: 1),
                        new Orbit(1, 6),
                        new Wander(0.2)
                        )
                    /*new State("orbit",
            ...
            .Init("shtrs Red Crystal",
                new State(
                    ...
                    new State("init",
                        new PlayerWithinTransition(15, "prepare portal once")
                        ),
                    new State("prepare portal once",
                        new TossObject("shtrs Fire Portal", 15, coolDown: 1000000),
                        new TimedTransition(25000, "prepare portal")
                        ),
                    new State("prepare portal",
                        new TimedTransition(25000, "throw")
                        ),
                    new State("throw",
                        new TossObject("shtrs Fire Portal", 15, coolDown: 1000000),
                        new TimedTransition(1000, "prepare portal")
                        )
                    /*new State("orbit",
                        new Orbit(1.0, 2, 5, "shtrs The Forgotten King"),
                        new Spawn("shtrs Fire Portal", maxChildren: 1, initialSpawn: 1, coolDown: 12000)
                        //new TimedTransition(8000, "dafuq")
                        ),
                    new State("dafuq",
                        new Orbit(1.0, 2, 5, "shtrs The Forgotten King"),
                    ...
                    new State("ThrowPortal",
                        new TossObject("shtrs Fire Portal", 12, coolDown: 8000, coolDownOffset: 7000, randomToss: false),
            ...
            .Init("shtrs Blue Crystal",
                new State(
                    ...
                    new State("prepare portal once",
                        new TossObject("shtrs Ice Portal", 15, coolDown: 1000000),
                        new TimedTransition(25000, "prepare portal")
                        ),
                    new State("prepare portal",
                        new TimedTransition(25000, "throw")
                    ...
                    /*new State("orbit",
                        new Orbit(1.0, 2, 5, "shtrs The Forgotten King"),
                        new Spawn("shtrs Ice Portal", maxChildren: 1, initialSpawn: 1, coolDown: 15000)
                        //new TossObject("shtrs Ice Portal", 12, coolDown: 8000, coolDownOffset: 7000, randomToss: false),
                        //new TimedTransition(8000, "dafuq")
                        ),
                    new State("dafuq",
                        new Orbit(1.0, 2, 5, "shtrs The Forgotten King"),
        ...
        #region 3rdbosschest
            .Init("shtrs Loot Balloon King",
                new State(
                    ...
                    new State("Crown",
                        new ThrowProjectile(0xbab, 4, 0, 5000),
                        new ThrowProjectile(0x5096, 4, 90, 5000),
                        new ThrowProjectile(0x5124, 4, 180, 5000),
                        new ThrowProjectile(0x233d, 4, 270, 5000)
                        )
                ),
                new MostDamagers(10,
