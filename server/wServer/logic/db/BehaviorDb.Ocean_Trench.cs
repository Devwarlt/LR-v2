        ...
        _ Ocean_Trench = () => Behav()
         .Init("Coral Gift",
          ...
          new MostDamagers(5,
                ...
                new ItemLoot("Coral Bow", goodloot*10),
                new ItemLoot("Coral Venom Trap", whitebag*10),
                new ItemLoot("Coral Silk Armor", goodloot*10),
                new ItemLoot("Coral Ring", normalloot*10)
              ),
          new MostDamagers(3,
              new OnlyOne(
                   new ItemLoot("Red Coral Bow", blackbag*2.5),
                   new ItemLoot("Red Coral Venom Trap", blackbag*2.5),
                   new ItemLoot("Red Coral Silk Armor", blackbag*2.5),
                   new ItemLoot("Red Coral Ring", blackbag*2.5)
                   ),
                new ItemLoot("Coral Juice", 0.1),
                new ItemLoot("Wine Cellar Incantation", awesomeloot*10),
                new ItemLoot("The Moon Tarot Card", awesomeloot*10),
                new ItemLoot("Golden Conch", awesomeloot*10),
                new ItemLoot("Golden Cockle", awesomeloot*10),
                new ItemLoot("Golden Horn Conch", awesomeloot*10)
              )
          )
         ...
         .Init("Deep Sea Beast",
          ...
          new MostDamagers(5,
                new ItemLoot("Potion of Mana", 1),
                new ItemLoot("Coral Bow", goodloot),
                new ItemLoot("Coral Venom Trap", whitebag),
                new ItemLoot("Coral Silk Armor", goodloot),
                new ItemLoot("Coral Ring", normalloot)
              ),
          new MostDamagers(3,
              new OnlyOne(
                   new ItemLoot("Red Coral Bow", blackbag),
                   new ItemLoot("Red Coral Venom Trap", blackbag),
                   new ItemLoot("Red Coral Silk Armor", blackbag),
                   new ItemLoot("Red Coral Ring", blackbag)
                   ),
                new ItemLoot("Wine Cellar Incantation", winecellar),
                new ItemLoot("Coral Juice", poorloot),
                new ItemLoot("The Moon Tarot Card", awesomeloot),
                new ItemLoot("Golden Conch", awesomeloot),
                new ItemLoot("Golden Cockle", awesomeloot),
                new ItemLoot("Golden Horn Conch", awesomeloot)
              )
         )
