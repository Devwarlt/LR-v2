        ...
        .Init("False Puppet Master",
          ...
          .Init("Puppet Loot Chest",
                ...
                new MostDamagers(5,
                    ...
                    new ItemLoot("Large Jester Argyle Cloth", 0.07),
                    new ItemLoot("Small Jester Argyle Cloth", 0.11),
                    new ItemLoot("The Fool Tarot Card", awesomeloot),
                    new ItemLoot("Wine Cellar Incantation", winecellar)
                    ),
                new MostDamagers(3,
                    new OnlyOne(
                        new ItemLoot("Harlequin Armor", whitebag),
                        new ItemLoot("Prism of Dancing Swords", whitebag),
                        new ItemLoot("Puppet Master Skin", whitebag),
                        new ItemLoot("Jester Skin", whitebag),
                        new ItemLoot("Royal Breastplate", whitebag)
                        ),
