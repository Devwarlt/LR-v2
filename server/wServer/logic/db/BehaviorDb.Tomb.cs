        ...
        private _ Tomb = () => Behav()
            .Init("Tomb Defender",
                ...
                new MostDamagers(5,
                    new ItemLoot("Potion of Life", 1),
                        new OnlyOne(
                            new ItemLoot("Ring of the Pyramid", mediumloot),
                            new ItemLoot("Unbound Ring of the Pyramid", normalloot),
                            new ItemLoot("Ancient Tome of Holy Protection", blackbag*5),
                            new ItemLoot("Tome of Holy Protection", mediumloot)
                            )
                    ),
                new MostDamagers(10,
                    ...
                    new ItemLoot("Pharaoh's Mask", awesomeloot),
                    new ItemLoot("Golden Ankh", awesomeloot),
                    new ItemLoot("Eye of Osiris", awesomeloot)
                    )
            )
           ...
           .Init("Active Sarcophagus",
              new State(
                 new State("Start",
                     new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                     new EntitiesNotExistsTransition(25, "Idle", "Beam Priestess", "Beam Priest")
                      ),
                 new State("Idle",
           ...
           .Init("Beam Priestess",
                ...
                new ItemLoot("Geb's Ring of Wisdom", 0.02)
                        ...
                        new MostDamagers(5,
                            new ItemLoot("Potion of Life", 1),
                                new OnlyOne(
                                    new ItemLoot("Ring of the Sphinx", mediumloot),
                                    new ItemLoot("Unbound Ring of the Sphinx", normalloot)
                                    )
                            ),
                        new MostDamagers(10,
                            new EggLoot(EggRarity.Common, eggbag + goodloot),
                        ...
                        new MostDamagers(5,
                            new ItemLoot("Potion of Life", 1),
                                new OnlyOne(
                                    new ItemLoot("Ring of the Nile", mediumloot),
                                    new ItemLoot("Unbound Ring of the Nile", normalloot),
                                    new ItemLoot("Book of Geb", awesomeloot),
                                    new ItemLoot("Scepter of Geb", awesomeloot),
                                    new ItemLoot("Shendyt of Geb", awesomeloot)
                                    )
                            ),
                        new MostDamagers(10,
                            new EggLoot(EggRarity.Common, eggbag + goodloot),
